...
if(USE_PCPOWER)
  ...
  if (USE_MPI)
    ...
    set(CMAKE_CXX_COMPILER "/opt/nvidia/hpc_sdk/Linux_x86_64/22.5/comm_libs/mpi/bin/mpic++")
...
if(USE_GPU)
  ...
  set(CMAKE_Fortran_FLAGS         "-cpp -lstdc++ -lmpi_cxx -DNOACC -DNOPRED")
  set(CMAKE_Fortran_FLAGS_RELEASE "-cpp -lstdc++ -lmpi_cxx -DNOACC -DNOPRED")
  set(CMAKE_Fortran_FLAGS_DEBUG   "-cpp -lstdc++ -lmpi_cxx -DNOACC -DNOPRED")
endif()
