...
if(USE_GPU)
  ...
  if(USE_MN)
    ...
    set(CMAKE_Fortran_FLAGS         "-cpp -lstdc++  -DNOPRED -DNOACC -O3")
    set(CMAKE_Fortran_FLAGS_RELEASE "-cpp -lstdc++  -DNOPRED -DNOACC -O3")
    set(CMAKE_Fortran_FLAGS_DEBUG   "-cpp -lstdc++  -DNOPRED -DNOACC -O3")
  endif()
endif()
