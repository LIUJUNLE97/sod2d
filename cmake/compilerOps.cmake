...
elseif(CMAKE_C_COMPILER_ID STREQUAL "NVHPC" OR CMAKE_C_COMPILER_ID STREQUAL "PGI")
	...
	if(USE_GPU AND USE_MEM_MANAGED)
		...
		if(USE_PCPOWER)
			...
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc86,cuda12.2,managed,lineinfo -cuda -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc86,cuda12.2,managed,lineinfo -cuda -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc86,cuda12.2,managed,lineinfo -cuda -acc")
		endif()
	elseif(USE_GPU)
