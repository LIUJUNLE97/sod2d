   ...
   set(CMAKE_Fortran_FLAGS_DEBUG ${CMAKE_Fortran_FLAGS_DEBUG} "-Minform=inform -C -Mchkstk -traceback -Ktrap=fp")
	...
	if(USE_GPU AND USE_MEM_MANAGED)
		...
		elseif(USE_PCPOWER)
			...
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc${GPU_CC},managed,lineinfo -cuda -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc${GPU_CC},managed,lineinfo -cuda -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc${GPU_CC},managed,lineinfo -cuda -acc")
		endif()
	elseif(USE_GPU)
		...
		elseif(USE_PCPOWER)
			...
			set_cc()
			#message("IMPORTANT: Verify the device compute capability!!!")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc${GPU_CC},lineinfo -cuda -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc${GPU_CC},lineinfo -cuda -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc${GPU_CC},lineinfo -cuda -acc")
		endif()
	else()
