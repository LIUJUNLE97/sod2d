...
elseif(CMAKE_C_COMPILER_ID STREQUAL "NVHPC" OR CMAKE_C_COMPILER_ID STREQUAL "PGI")
   ...
   set(CMAKE_Fortran_FLAGS_DEBUG ${CMAKE_Fortran_FLAGS_DEBUG} "-Minform=inform -C -Mchkstk -traceback -Ktrap=fp")
	...
	if(USE_GPU AND USE_MEM_MANAGED)
		...
		if(USE_MN5)
			message("Setting up ACC flags with CC90 CUDA 12.3")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc90,cuda12.3,managed,lineinfo -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc90,cuda12.3,managed,lineinfo -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc90,cuda12.3,managed,lineinfo -acc")
		elseif(USE_PCPOWER)
			message("Setting up ACC flags with CC70 CUDA 10.2")
		...
		elseif(USE_ALVIS)
			message("Setting up ACC flags with CC80")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc80,cuda11.7,managed,lineinfo -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc80,cuda11.7,managed,lineinfo -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc80,cuda11.7,managed,lineinfo -acc")
		elseif(USE_BERZELIUS)
			message("Setting up ACC flags with CC80")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc80,cuda11.8,managed,lineinfo -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc80,cuda11.8,managed,lineinfo -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc80,cuda11.8,managed,lineinfo -acc")
		else()
	...
	elseif(USE_GPU)
		...
		if(USE_MN5)
			message("Setting up ACC flags with CC90 CUDA 12.3")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc90,cuda12.3,lineinfo -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc90,cuda12.3,lineinfo -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc90,cuda12.3,lineinfo -acc")
		elseif(USE_PCPOWER)
			message("Setting up ACC flags with CC70 CUDA 10.2")
		...
		elseif(USE_ALVIS)
			message("Setting up ACC flags with CC80")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc80,cuda11.7,lineinfo -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc80,cuda11.7,lineinfo -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc80,cuda11.7,lineinfo -acc")
		elseif(USE_BERZELIUS)
			message("Setting up ACC flags with CC80")
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc80,cuda11.8,lineinfo -acc")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc80,cuda11.8,lineinfo -acc")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc80,cuda11.8,lineinfo -acc")
		else()
			message("IMPORTANT: Verify the device compute capability!!!")
