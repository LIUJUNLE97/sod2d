...
elseif(CMAKE_C_COMPILER_ID STREQUAL "NVHPC" OR CMAKE_C_COMPILER_ID STREQUAL "PGI")
	...
	if(USE_GPU)
		...
		if (USE_MEM_MANAGED)
			...
			if(USE_AUTOCOMPARE)
				message( FATAL_ERROR "USE_MEM_MANAGED and USE_AUTCOMPARE cannot be ON at same time!")
			endif()
		else()
			if(USE_AUTOCOMPARE)
				message("Setting up ACC flags with AUTOCOMPARE option")
				set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-gpu=cc${GPU_CC},cuda${GPU_CUDA},lineinfo,autocompare -cuda -acc -DAUTOCOMP")
				set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-gpu=cc${GPU_CC},cuda${GPU_CUDA},lineinfo,autocompare -cuda -acc -DAUTOCOMP")
				set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-gpu=cc${GPU_CC},cuda${GPU_CUDA},lineinfo,autocompare -cuda -acc -DAUTOCOMP")
			else()
