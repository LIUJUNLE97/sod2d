...
elseif(CMAKE_C_COMPILER_ID STREQUAL "Intel" OR CMAKE_C_COMPILER_ID STREQUAL "IntelLLVM")
	...
	if(USE_MN5)
		...
		set(CMAKE_C_FLAGS_RELEASE ${CMAKE_C_FLAGS_RELEASE} "-xSAPPHIRERAPIDS -arch SAPPHIRERAPIDS")
		set(CMAKE_CXX_FLAGS_RELEASE ${CMAKE_CXX_FLAGS_RELEASE} "-xSAPPHIRERAPIDS -arch SAPPHIRERAPIDS")
		set(CMAKE_Fortran_FLAGS_RELEASE ${CMAKE_Fortran_FLAGS_RELEASE} "-xSAPPHIRERAPIDS -arch SAPPHIRERAPIDS -qopt-zmm-usage=high")
	elseif(USE_MN4)
