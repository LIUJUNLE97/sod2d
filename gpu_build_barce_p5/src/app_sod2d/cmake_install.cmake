...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/scratch/junle/CODE_SOD2D/sod2d_gitlab/gpu_build_barce_p5/src/app_sod2d/sod2d")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/sod2d" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/sod2d")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/sod2d"
         OLD_RPATH "/scratch/junle/CODE_SOD2D/sod2d_gitlab/gpu_build_barce_p5/external/json-fortran/lib:/scratch/muma/libs/hdf5/1.14.3-sdk24.5/lib:"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include" TYPE DIRECTORY FILES "/scratch/junle/CODE_SOD2D/sod2d_gitlab/gpu_build_barce_p5/modules")
endif()
