      ...
      contains
          ...
          if (flag_cg_mem_alloc_veloc .eqv. .true.) then
           ...
           call nvtxStartRange("CG_u init")
            ...
            call full_diffusion_ijk_meshElasticity(nelem,npoin,connec,Ngp,He,gpvol,dlxigp_ip,invAtoIJK,gmshAtoI,gmshAtoJ,gmshAtoK,x_u,nu,E,Ml,qn_u)
           ...
           do iter = 1,maxIter
              ...
              call full_diffusion_ijk_meshElasticity(nelem,npoin,connec,Ngp,He,gpvol,dlxigp_ip,invAtoIJK,gmshAtoI,gmshAtoJ,gmshAtoK,p0_u,nu,E,Ml,qn_u)
              if(mpi_size.ge.2) then
                  call mpi_halo_atomic_update_real_arrays(ndime,qn_u(:,:))
               end if
