module mod_bc_routines_meshElasticity
   ...
   implicit none
      ...
      contains
         ...
         subroutine temporary_bc_routine_dirichlet_prim_residual_meshElasticity(&
           npoin,nboun,bou_codes_nodes,normalsAtNodes,aux_u,u_buffer)
        ...
        subroutine temporary_bc_routine_dirichlet_prim_meshElasticity(&
          npoin,nboun,bou_codes_nodes,lnbn_nodes,normalsAtNodes,aux_u,u_buffer)
