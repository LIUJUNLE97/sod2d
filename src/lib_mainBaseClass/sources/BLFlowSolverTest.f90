module BLFlowSolverTest_mod
   ...
   contains
      ...
      procedure, public :: initializeParameters  => BLFlowSolverTest_initializeParameters
      procedure, public :: evalInitialConditions => BLFlowSolverTest_evalInitialConditions
      procedure, public :: initialBuffer => BLFlowSolverTest_initialBuffer
      procedure, public :: fillBlasius => BLFlowSolverTest_fillBlasius
      procedure, public :: beforeTimeIteration => BLFlowSolverTest_beforeTimeIteration
      procedure, public :: afterTimeIteration => BLFlowSolverTest_afterTimeIteration
      procedure, public :: afterDt => BLFlowSolverTest_afterDt
      procedure, public :: computeTw => BLFlowSolverTest_computeTw
      end type BLFlowSolverTest
contains

   subroutine BLFlowSolverTest_afterDt(this,istep)
   ...
   end subroutine BLFlowSolverTest_fill_BC_Types

   subroutine BLFlowSolverTest_fillBlasius(this)
      class(BLFlowSolverTest), intent(inout) :: this
   ...
   end subroutine BLFlowSolverTest_fillBlasius
   ...
   subroutine BLFlowSolverTest_afterTimeIteration(this)
      class(BLFlowSolverTest), intent(inout) :: this
      if (mpi_rank .eq. 0) close(446)
   end subroutine BLFlowSolverTest_afterTimeIteration

   subroutine BLFlowSolverTest_initializeParameters(this)
      class(BLFlowSolverTest), intent(inout) :: this
      real(rp) :: mur
      integer :: num_args, equal_pos, iarg, ierr
      character(len=64) :: arg, output_dir
      character(len=8) :: restart_step_str="", periodEpisode_str="1.0"
      logical :: output_dir_exists

      ! get command line args, ie: mpirun -n 4 sod2d --restart_step=1
      ...
      this%save_vectorField_curlU      = .false.
   ...
   end subroutine BLFlowSolverTest_initializeParameters

   subroutine BLFlowSolverTest_initialBuffer(this)
      class(BLFlowSolverTest), intent(inout) :: this
   ...
   end subroutine BLFlowSolverTest_initialBuffer

   subroutine BLFlowSolverTest_evalInitialConditions(this)
      class(BLFlowSolverTest), intent(inout) :: this
      ...
      !$acc end kernels
      call nvtxEndRange
   end subroutine BLFlowSolverTest_evalInitialConditions

end module BLFlowSolverTest_mod
