module BLFlowSolverIncompTest_mod
   use mod_arrays
   use mod_nvtx
#ifndef NOACC
   use cudafor
   ...
   contains
      ...
      procedure, public :: initializeParameters  => BLFlowSolverIncompTest_initializeParameters
      procedure, public :: evalInitialConditions => BLFlowSolverIncompTest_evalInitialConditions
      procedure, public :: initialBuffer => BLFlowSolverIncompTest_initialBuffer
      procedure, public :: fillBlasius => BLFlowSolverIncompTest_fillBlasius
...
contains
   ...
   subroutine BLFlowSolverIncompTest_beforeTimeIteration(this)
   ...
   subroutine BLFlowSolverIncompTest_fillBlasius(this)
      class(BLFlowSolverIncompTest), intent(inout) :: this
  ...
  end subroutine BLFlowSolverIncompTest_fillBlasius

   subroutine BLFlowSolverIncompTest_initializeParameters(this)
      class(BLFlowSolverIncompTest), intent(inout) :: this
      real(rp) :: mur
      integer :: num_args, equal_pos, iarg, ierr
      character(len=64) :: arg, output_dir
      character(len=8) :: restart_step_str="", periodEpisode_str=""
   ...
   subroutine BLFlowSolverIncompTest_initialBuffer(this)
      class(BLFlowSolverIncompTest), intent(inout) :: this
   ...
   end subroutine BLFlowSolverIncompTest_initialBuffer

   subroutine BLFlowSolverIncompTest_evalInitialConditions(this)
      class(BLFlowSolverIncompTest), intent(inout) :: this
      ...
      !$acc end parallel loop
   end subroutine BLFlowSolverIncompTest_evalInitialConditions

end module BLFlowSolverIncompTest_mod
