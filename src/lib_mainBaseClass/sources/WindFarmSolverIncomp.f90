...
subroutine WindFarmSolverIncomp_readJSONAD(this)
   ...
   subroutine WindFarmSolverIncomp_initializeParameters(this)
      ...
      call json%get("wmles_walex",wmles_walex, found,0.1_rp); !optional depending of the model      call json%get("flag_fs_fix_pressure",flag_fs_fix_pressure, found,.false.); call this%checkFound(found,found_aux)
