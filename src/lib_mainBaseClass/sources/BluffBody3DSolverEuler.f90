...
module BluffBody3DSolverEuler_mod
   use mod_arrays
   use mod_nvtx
#ifndef NOACC
   use cudafor
   ...
   type, public, extends(CFDSolver3DWithBoundaries) :: BluffBody3DSolverEuler

      real(rp) , public  :: vo, M, delta, rho0,to, po, aoa_alpha, aoa_beta

   contains
      procedure, public :: fillBCTypes           =>BluffBody3DSolverEuler_fill_BC_Types
      procedure, public :: initializeParameters  => BluffBody3DSolverEuler_initializeParameters
      procedure, public :: evalInitialConditions => BluffBody3DSolverEuler_evalInitialConditions
      procedure, public :: initialBuffer => BluffBody3DSolverEuler_initialBuffer
   end type BluffBody3DSolverEuler
   
   contains

   subroutine BluffBody3DSolverEuler_fill_BC_Types(this)
      class(BluffBody3DSolverEuler), intent(inout) :: this

      call this%readJSONBCTypes()

   end subroutine BluffBody3DSolverEuler_fill_BC_Types

   subroutine BluffBody3DSolverEuler_initialBuffer(this)
      class(BluffBody3DSolverEuler), intent(inout) :: this
   ...
   end subroutine BluffBody3DSolverEuler_initialBuffer

   subroutine BluffBody3DSolverEuler_initializeParameters(this)
      use json_module
      implicit none
      class(BluffBody3DSolverEuler), intent(inout) :: this
      real(rp) :: mul, mur
      ...
      flag_implicit = 1
      implicit_solver = implicit_steady_euler
      flag_high_mach = .true.
   ...
   end subroutine BluffBody3DSolverEuler_initializeParameters

   subroutine BluffBody3DSolverEuler_evalInitialConditions(this)
      class(BluffBody3DSolverEuler), intent(inout) :: this
   ...
   end subroutine BluffBody3DSolverEuler_evalInitialConditions

end module BluffBody3DSolverEuler_mod
