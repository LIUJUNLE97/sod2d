   ...
   contains  
      ...
      subroutine hex64(xi,eta,zeta,listHEX08,N,dN,N_lagrange,dN_lagrange)
         ...
         if (present(listHEX08)) then
            listHEX08( 1,1:8) = [1,9,48,10,13,37,57,40]
            listHEX08( 2,1:8) = [9,10,36,33,37,38,58,57]
            listHEX08( 3,1:8) = [10,2,15,36,38,17,44,57]
            ...
            listHEX08(13,1:8) = [41,57,60,44,41,61,64,43]
            ...
            listHEX08(19,1:8) = [14,40,61,41,5,25,53,27]
            ...
            listHEX08(24,1:8) = [62,48,47,63,54,29,28,55]
