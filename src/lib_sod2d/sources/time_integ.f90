module time_integ
   ...
   subroutine end_rk4_solver()
      ...
      if(flag_implicit == 1) then
         ...
         subroutine rk_implicit_bdf2_rk10_main(igtime,save_logFile_next,currIter,noBoundaries,isWallModelOn,flag_predic,flag_emac,nelem,nboun,npoin,npoin_w,numBoundsWM,point2elem,lnbn,lnbn_nodes,dlxigp_ip,xgp,atoIJK,invAtoIJK,gmshAtoI,gmshAtoJ,gmshAtoK,&
            ...
            integer(4),           intent(in)    :: flag_predic, flag_emac,igtime,save_logFile_next
